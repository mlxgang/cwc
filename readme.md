...
- 0.6.5
  - Добавлены новые часто используемые поля. Небольшой редизайн - верхнее окно теперь вертикальное, общий поток контента - горизонтальный.
- 0.6.4
  - Фикс ценообразования, разделение итогового счет за ключи и за работу
- 0.6.3
